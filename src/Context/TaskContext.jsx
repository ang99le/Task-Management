...
const apiUrl = process.env.REACT_APP_API_URL || "http://localhost:5173/";
...
export const TaskProvider = ({ children }) => {
    ...
    return (
        <TaskContext.Provider value={{filteredTasks,totalTasks,completedTasks,todoTasks,handleFilterClick,addTask,deleteTask,editTask,updateTaskStatus,}}>
            {children}
